...
export const CardView: React.FC = () => {
  ...
  if (activeCardId === 'info') {
    return (
      <div className={cn(styles.container, styles.zoomIn)}>
        {/* Top Bar */}
        <div className="h-14 border-bottom border-border flex items-center px-4 lg:px-8 shrink-0 justify-between gap-4">
  ...
  if (!activeCardId) {
    return (
      <div className={styles.emptyState}>
        ...
        <h2 className={styles.emptyTitle}>Welcome to Folio</h2>
  ...
  if (!activeCardData) {
    return (
      <div className={styles.emptyState}>
        ...
        <h2 className={styles.emptyTitle}>Card not found</h2>
        <p className={styles.emptyDescription}>
  ...
  const animationClass = navigationDirection === 'in' ? styles.zoomIn : styles.zoomOut;

  return (
    <div className={cn(styles.container, animationClass)} key={activeCardId}>
      {/* Top Bar */}
      <div className="h-14 border-bottom border-border flex items-center px-4 lg:px-8 shrink-0 justify-between gap-4">
          ...
          {types.map(t => {
            ...
            return (
              <button
                ...
                className={cn(
                  "flex items-center gap-1.5 px-2 py-1 rounded-small text-[10px] font-bold uppercase tracking-wider transition-all",
          ...
          <div className="space-y-6">
            <div className="flex items-start justify-between gap-4">
              ...
              <button 
                ...
                className="mt-2 text-border hover:text-red-500 transition-colors"
                title="Delete card"
              >
                <Trash2 size={20} />
              </button>
